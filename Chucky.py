...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='Token_Kamu_Di_Sini_Sayang')
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='Token_Kamu_Di_Sini_Sayang')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='Token_Kamu_Di_Sini_Sayang')
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token='Token_Kamu_Di_Sini_Sayang')
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='Token_Kamu_Di_Sini_Sayang')
kr.loginResult()
