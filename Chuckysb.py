...
nadya = LINETCR.LINE()
#nadya.login(qr=True)
nadya.login(token='EoKiKP3UsEz0pAbH3w1b.fpzoe5O4f6/QVIFsn6/ZAW.U+H1xQcxN9XnD9i1MAsrGfyMQg9Myr022rCmhKTWjf0=')
nadya.loginResult()
    ...
    try:
		...
		try:
		    ...
		    nadya.leaveGroup(msg.to)
		          ...
		          nadya.sendText(msg.to,"Bilang Dulu Sama Admin Ku")		    
